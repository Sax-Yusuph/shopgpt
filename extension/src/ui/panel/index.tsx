...
import { Heading, IconButton, Kbd, Text, clx } from '@medusajs/ui'
...
>(({ className, container, ...props }, ref) => {
  return (
    <DrawerPortal container={container?.querySelector('#__panel')}>
      <DrawerOverlay />
      <DrawerPrimitives.Content
        ref={ref}
        className={clx(
          'bg-ui-bg-base shadow-elevation-modal border-ui-border-base fixed inset-y-2 end-2 flex w-full max-w-[560px] flex-1 flex-col rounded-lg border focus:outline-none',
          className,
        )}
        {...props}
      />
